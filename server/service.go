...
import (
	...
	"crypto/tls"
	"fmt"
	"github.com/SianHH/frp-package/pkg/congestion"
	...
	modelmetrics "github.com/SianHH/frp-package/pkg/metrics"
	...
	"github.com/SianHH/frp-package/pkg/ssh"
	"github.com/SianHH/frp-package/pkg/transport"
	httppkg "github.com/SianHH/frp-package/pkg/util/http"
	"github.com/SianHH/frp-package/pkg/util/log"
	netpkg "github.com/SianHH/frp-package/pkg/util/net"
	"github.com/SianHH/frp-package/pkg/util/tcpmux"
	"github.com/SianHH/frp-package/pkg/util/util"
	"github.com/SianHH/frp-package/pkg/util/version"
	"github.com/SianHH/frp-package/pkg/util/vhost"
	"github.com/SianHH/frp-package/pkg/util/xlog"
	"github.com/SianHH/frp-package/server/controller"
	...
	"github.com/SianHH/frp-package/server/proxy"
...
func NewService(cfg *v1.ServerConfig) (*Service, error) {
	...
	if cfg.VhostHTTPPort > 0 {
		...
		// TODO PATCH 修复停止后，不停止HTTPServer的问题
...
func (svr *Service) GetPluginManager() *plugin.Manager {
	return svr.pluginManager
}
